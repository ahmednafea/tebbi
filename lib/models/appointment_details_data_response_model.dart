...
class AppointmentDetailsDataResponseModel {
  final String? message;
  final AppointmentData? data;
  final bool? status;
  final int? code;

  AppointmentDetailsDataResponseModel({
    this.message,
    this.data,
    this.status,
    this.code,
  ...
  factory AppointmentDetailsDataResponseModel.fromJson(String str) =>
      AppointmentDetailsDataResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AppointmentDetailsDataResponseModel.fromMap(
    Map<String, dynamic> json,
  ) => AppointmentDetailsDataResponseModel(
    message: json["message"],
    data: json["data"] == null ? null : AppointmentData.fromMap(json["data"]),
    status: json["status"],
    code: json["code"],
  );
